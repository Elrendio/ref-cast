...
use {
    ...
    proc_macro2::{Ident, Span, TokenStream as TokenStream2, TokenTree},
    ...
    syn::{
        ...
        token, Abi, Attribute, Data, DeriveInput, Error, Expr, Field, Generics, Path, Result,
...
///
/// ```
/// use {ref_cast::RefCast, std::marker::PhantomData};
///
/// #[derive(RefCast)]
/// #[repr(transparent)]
...
/// - `#[ref_cast(crate = "...")]`
///
///  Specify a path to the `ref_cast` crate instance to use when referring to `ref_cast` APIs from
/// generated code. This is normally only applicable when invoking re-exported `ref_cast` derives
/// from a public macro in a different crate. ```
/// pub use ref_cast;
/// #[macro_export]
